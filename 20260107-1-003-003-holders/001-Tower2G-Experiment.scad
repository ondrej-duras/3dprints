...
/* [Previews] */
preview="basic"; // [basic,variants-antena,variants-tower,variants-holder,slider,movie,plate,plate-holders,plate-tower]
...
if(preview=="plate-holders") {
    ...
    y3=2*holderDepth;
    translate([0,y3,0])  // pridrzanie holderov, aby ich tlacova hlava nezhodila pocas tlacenia
        cube([57*holderWidth,1,1]);
    ...
    for(x=[33*holderWidth:6*holderWidth:56*holderWidth]) {
        translate([x,y3,0])
            holderCylinder();
        translate([x+3*holderWidth,y3,0])
            holderEye();
    }

    y4=y3+20;
    translate([0,y4,0])  // pridrzanie holderov, aby ich tlacova hlava nezhodila pocas tlacenia
        cube([57*holderWidth,1,1]);
    ...
    for(x=[33*holderWidth:6*holderWidth:56*holderWidth]) {
        translate([x,y4,0])
            holderTooth();
        translate([x+3*holderWidth,y4,0])
            holderLightingRodUp();
    }
} // plate
