...
cabWidth=140;  // [70:140] 75 sirka kabinetu tecoTower-a
cabHight=80;   // [50:100] 60 vyska kabinetu
cabDepth=50;   // [20:70]  30 hlbka kabinetu
cabTick=2.0;   // [1:0.1:3] 2.0 hrubka steny kabinetu 
doorWidth=50;  // [30:60]  30 sirka dveri
doorHight=70;  // [40:80]  40 vyska dveri
door1at=15;    // [5:1:20] umiestnenie 1.dveri od odkraja skrinky, 2.dvere nizsie 
...
module cabPant() {
    union() {
        translate([2,-pantDepth/2-hingeSpi-hingeSpo,0])
            cylinder(h=8,d=pantStick-2*hingeSpi);
        difference() {
   ...
   difference() { 
        union() {
            ...
            translate([2,-pantDepth,0])  // hranol
                cube([16,pantDepth-hingeSpi-hingeSpo,4]);
            translate([2,-pantDepth/2-hingeSpi-hingeSpo,0])  // a cylinder vonkajsej casti
                cylinder(h=4,d=pantDepth-hingeSpi-hingeSpo);
        }
        translate([2,-pantDepth/2-hingeSpi-hingeSpo,-1]) // diera
            cylinder(h=6,d=pantStick+2*hingeSpo);
...
module rightPant() { // pant na dverach otvaranych do prava
   difference() { 
        ...
        translate([2,-pantDepth/2-hingeSpi-hingeSpo,-1]) // diera
            cylinder(h=6,d=pantStick+hingeSpo);
