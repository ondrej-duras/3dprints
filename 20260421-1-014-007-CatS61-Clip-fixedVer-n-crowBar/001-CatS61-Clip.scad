...
sliderHightM=4.0;   // celkova vyska slidera - oboch pasikov dohromady
sliderHightB=2.0;   // vyska spodnych-leziacich dvoch pasikov slidera
sliderHightT=2.0;   // vyska horneho-noseneho pasika slidera
sliderCutLen=10.5;  // dlzka zarezu do slidera .. su dva
sliderCutTck=1.51;  // hrubka (Tick) zarezu do sldera .. su dva (merany original 1.5)
sliderCutDis=5.5;   // vzdialenost okraja zarezu od okraja slidera
sliderTipWid=8.0;   // sirka drziaceho hrotu i vyhynacieho jazycka
...
coverTick=1.0;      // hrubka materialu cover-a
...
// referencny bod je vlavo dole v zadu na chrbate
    ...
    difference() {
        color(colorCover)
            //cube([sliderWidthT,sliderDepthL,ferulaHight+coverTick+sliderHightT]);
            roundedCoverDown(sliderWidthT,sliderDepthL,ferulaHight+coverTick+sliderHightT,roundedRadiusBig,roundedRadius);
        color(colorCover)
            translate([coverTick,-1,coverTick])
            //cube([sliderWidthT-2*coverTick,sliderDepthL-coverTick+1,ferulaHight+coverTick+sliderHightT]);
            roundedCoverDown(sliderWidthT-2*coverTick,sliderDepthL-coverTick+1,ferulaHight+coverTick+sliderHightT,roundedRadiusBig,roundedRadius);
    } //diff
        color(colorSliderBottom)                            // prva ferula od predneho okraja
