...
setup="design_tray_fan"; // [design_tray_linecards, design_tray_fan, design_tray_psu, design_fan, design_psu, design_filters, design_cards, present_delabored, models, print_sr7, spare_parts, plate_filterBox,basic_halfCards,plate_halfCards]
preview=true;  // iba na schovanie sekcie "preview"
// seriove cislo
serial_number="20251217-3";
// Nazov / Venovanie
code_name="015-mSR7-i2";
